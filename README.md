...
1. **Download the installer**:
   - Download [MailConsolidator-Setup-1.0.0.exe](https://github.com/techstrom/MailConsolidator/releases/download/v1.0.0/MailConsolidator-Setup-1.0.0.exe)

2. **Run the installer**:
   - Double-click the downloaded `MailConsolidator-Setup-1.0.0.exe`
